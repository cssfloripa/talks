...
<p align=center>
    🎙 Repositório para submissão, feedback e escolha de talks dos meetups do CSS Floripa.
</p>

## Como faço para enviar minha talk?

Para enviar uma talk basta [abrir uma issue](https://github.com/cssfloripa/talks/issues/new) no [Issue Tracker desse repositório](https://github.com/cssfloripa/talks/issues) e seguir o template disponível (que vai aparecer escrito automaticamente no corpo da issue).
...
Após cada Meetup iremos fechar as issues com talks de Meetups anteriores, por isso essas irão ficar na [aba de issues fechadas do GitHub](https://github.com/cssfloripa/talks/issues?utf8=%E2%9C%93&q=is%3Aissue%20is%3Aclosed).
